...
export default function AnnouncementCard({ announcement, delay = 0, onMarkRead, onOpen }) {
  ...
  return (
    <motion.div
      ...
      className={`bg-[#111] border rounded-xl p-5 transition-colors
        ${!isRead ? "border-yellow-400/15 hover:border-yellow-400/30" : "border-gray-800 hover:border-gray-700"} cursor-pointer`}
    >
      {/* Header row */}
