...
export const authClient = axios.create({
  baseURL: import.meta.env.VITE_API_BASE_URL_AUTH || 'http://localhost:5000/api/v1/admin/auth',
...
apiClient.interceptors.response.use(
  ...
  async (error) => {
    ...
    try {
      ...
      const refreshResponse = await authClient.post('/admin/refresh-token', {}); // adjust path if needed
